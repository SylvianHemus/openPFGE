...
#define EepromAddress 0 // eeprom address for config saving
...
void setup() {
  ...
  // eeprom storage
  eeprom_read_string(EepromAddress, tmpBuffer, tmpBufferSize);
  setParams();
}
...
void checkSerial() {
  if (BT.available())
  {
    ...
    encodeCurrent();
    eeprom_write_string(EepromAddress, tmpBuffer); // save new values to eeprom
  }
}
...
// EEPROM Methods
// https://gist.githubusercontent.com/smching/05261f11da11e0a5dc834f944afd5961/raw/2abe8e9331af7f51bdea4ed43942f4013440d07f/Arduino%2520reading%2520and%2520writing%2520string%2520to%2520EEPROM
